		...
		<div class="body">
            ...
            <div class="note note-danger" id="errorMessageCheckEmail" style="display:none">
	  		...
	  		<p style="padding:10px 10px 0px 0px">
				<span class="label label-important"><?php _e( "Note: You will need to Assign your Employees to the respective Services in order to allow Bookings for your Clients.", bookings_plus ); ?></span>					
			</p>            
	...
	<form id="uxFrmAllocateServices" class="form-horizontal" method="post" action="#">
		<div class="body">
			...
			<div class="note note-danger" id="allocatedErrorMessage" style="display:none">
	  		...
	  		<p style="padding:10px 10px 0px 0px">
				<span class="label label-important"><?php _e( "Note: Please choose Staff Member and then tick the appropriate checkbox next to each service you wish to Assign.", bookings_plus ); ?></span>					
			</p>       
	        <div class="block well" style="margin-top:10px;">
	            <div class="row-fluid form-horizontal">
	            	<div class="control-group">
...
<div id="adminEmailId" style="display: none;width:800px;">
	<form id="uxFrmAdminEmail" style="display: block" class="form-horizontal" method="post" action="#">	
		<div class="modal-header">	
	    ...
	    <div class="form-actions" style="padding:0px 10px 10px 0px;">
			<input type="submit" value="<?php _e( "Save & Next", bookings_plus ); ?>"  id="btnAdminEmail" class="btn btn-info pull-right">
		</div>  
	</form>
	<div id="youtubeVideo" style="display:none;">
		<div class="modal-header">	
 			<h5><?php _e( "Demo Video to Setup Plugin", bookings_plus ); ?></h5>	    	
    	</div>
    	<div class="block well" style="margin:10px">
    		<p style="padding:10px 10px 0px 10px">
					<span class="label label-info"><?php _e( "Note: Kindly have a look at the video to get an idea of how to setup the Bookings Plus Plugin", bookings_plus ); ?></span>					
					
				</p> 
			<div class="body" style="text-align:center">
				<object width="532" height="325">
					<param name="movie" value="http://www.youtube.com/v/73my379zGN0?fs=1">
					<param name="allowFullScreen" value="true"><param name="allowscriptaccess" value="never">
					<embed src="http://www.youtube.com/v/73my379zGN0?fs=1" type="application/x-shockwave-flash" allowscriptaccess="never" allowfullscreen="true" width="532" height="325">
				</object>
			</div>
		</div> 
		<div class="form-actions" style="padding:0px 10px 10px 0px;">
			<input type="button" value="<?php _e( "Proceed Next to Copy Short Codes", bookings_plus ); ?>"  id="btnAdminEmail" onclick="watchVideo();" class="btn btn-info pull-right">
		</div> 
	</div>
	<div id="ForntEndShortCode" style="display:none;">
		<div class="modal-header">
		   <h5>
		...
		<div class="block well" style="margin:10px">
			<p style="padding:10px 10px 0px 10px">
					<span class="label label-info"><?php _e( "Note: Copy any one of the shortcode to implement Booking Form on Front End Pages/Posts", bookings_plus ); ?></span>					
...
function watchVideo()
{
	jQuery("#ForntEndShortCode").css("display","block");
	jQuery("#youtubeVideo").css("display","none");
	    ...
	    submitHandler: function(form) 
	   	{
			...
			({
				...
				success: function(data) 
				{
						...
						jQuery("#uxFrmAdminEmail").css("display","none");
					 	jQuery("#youtubeVideo").css("display","block");
...
{
	jQuery("#adminEmailId").css("display","none");
	jQuery("#ForntEndShortCode").css("display","block");
	jQuery.fancybox.update();
}
